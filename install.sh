...
# Config files
git clone git@github.com:Sharu95/config.git config
cat config/scripts/start_env.sh >> $HOME/$BASH_PROFILE
cp config/.vimrc $HOME/.vimrc

# Git-radar
git clone git@github.com:michaeldfallen/git-radar.git git-radar
